...
import { Home, HomeIcon, LogOut, Package, PanelBottom, Settings2, ShoppingBag, User } from 'lucide-react';
...
export function Sidebar() {
    return(
        <div className="flex w-full flex-col bg-muted/40">
            ...
            <aside className='fixed inset-y-0 left-0 z-10 hidden border-r bg-background
            sm:flex flex-col'>
